...
class SupplierController extends Controller
{
    ...
    {
        $details = array();
        $selectd =  DB::table('bills')
        ->select(DB::raw('count(bill_total) AS total'))
        ...
        $selectdprojects =  DB::table('bills')
        ->select(DB::raw('SUM(bill_total) AS unpaid'))
        ->where('cur_status', '!=', 'paid')
        ->get();
