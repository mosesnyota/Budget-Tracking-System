    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="/finance/home" class="waves-effect">
                ...
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="/finance/projects"><b class="dripicons-briefcase" > Manage Projects </b></a></li>
                ...
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="/finance/funds"><b class="fas fa-money-check-alt" aria-hidden="true"> Manage Funds </b></a></li>
                    </ul>
                </li>
                @endcan
                ...
                @can('VIEW EXPENSES')<li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="/finance/expense"><b class="fas fa-money-check-alt" aria-hidden="true"> Manage Expenses </b></a></li>
                        <li><a href="/finance/bills"><b class="fas fa-money-check-alt" aria-hidden="true"> Manage Bills </b></a></li>
                    </ul>
                </li>
                @endcan
                ...
                @can('VIEW STAFF')<li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="/finance/staff"> <b class="fa fa-users" > Manage Staff </b></a></li>
                    </ul>
                </li> @endcan
                ...
                @can('VIEW SUPPLIERS')<li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="/finance/suppliers"> <b class="fa fa-users" > Manage Suppliers </b></a></li>
                    </ul>
                </li> @endcan
                ...
                @can('VIEW DONORS')<li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="/finance/sponsors"> <b class="dripicons-user" > Manage Financiers </b></a></li>
                    </ul>
                </li> @endcan
                ...
                @can('VIEW PETTY CASH')<li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="/finance/pettycash"> <b class="fas fa-dollar-sign" > Manage Transactions </b></a></li>
                    </ul>
                </li> @endcan
                ...
                @can('VIEW ANALYTICS') <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="/finance/expenseanalytics">Expenses Trends</a></li>
                        <li><a href="/finance/incomeanalytics">Income Trends</a></li>
                    </ul>
                </li> @endcan
                ...
                @can('IS ADMINISTRATOR')<li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="/finance/roles">Manage Roles</a></li>
                        <li><a href="/finance/permissions">Manage Permissions</a></li>
                    </ul>
                </li> @endcan
