    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9">
                    <a href="/blog/public/pettycashreport" target="_blank" class="btn btn-warning btn-md float-right mr-1" role="button"><b class="fa fa-file-pdf-o"> Print Report </b></a>
                    <button type="button"  class="btn btn-primary btn-md float-right mr-1"  data-toggle="modal" data-target="#modal-issuefunds" data-backdrop="static" data-keyboard="false" href="#"> <b class="fa fa-file-pdf-o"> Statement </b></button>
