            ...
            <div class="col-sm-12">
                <div class="page-title-box">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h4 class="page-title m-0">EDIT EXPENSE TRANSACTION</h4>
                        </div>
                        <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <form role="form" method="post" action="update" enctype="multipart/form-data" >
                        ...
                        <div class="form-group row">
                            <label for="expense_amount" class="col-sm-2 col-form-label">Expense Amount:</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="trasnref" autocomplete="off" id="trasnref" class="form-control" value="{{$expense->trasnref}}">
                                </div>
                            </div>
                        </div>
