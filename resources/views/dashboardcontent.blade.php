            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="mt-0 header-title mb-4">Recent Reports</h4>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p class="text-muted mb-0">Punda Milia</p></td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h6 class="mt-0">2020</h6>
                                                <p class="text-muted mb-0">Hostel Construction</p></td>
                                            <td>
                                                <a href="#" class="btn btn-primary btn-sm">
                                                    <i class="fas fa-download"></i>
                                                </a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h6 class="mt-0">2020</h6>
                                                <p class="text-muted mb-0">Nzaikoni Classroom</p></td>
                                            <td>
                                                <a href="#" class="btn btn-primary btn-sm">
                                                    <i class="fas fa-download"></i>
                                                </a>
